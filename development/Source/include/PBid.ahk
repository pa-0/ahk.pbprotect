...
; ======================================================================
CreateID(RegUserName, RegEmail, SaltString, RegApplName, RegApplVersion, RegApplFileName, LT1, LT2, LT3, LT4, LT5, LT6, LT7, HashType) {
  ...
  Return Crypt.Hash.StrHash(Output, HashType)
}
